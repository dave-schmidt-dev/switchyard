...
export function executeCodex(prompt, workingContainerName, options = {}) {
	...
	const argv = [
		...
		// unprivileged userns is disallowed inside the working sandbox, so bwrap
		// can't initialize (`bwrap: No permissions to create a new namespace`).
		// Verified live 2026-07-26: the default (read-only) and
		...
		// (INV-1: no host FS mount, no host creds; disposable,
