...
| `src/switchyard/lifecycle/parallels-execution-backend.mjs` | Task 4.1 Parallels lifecycle: UUID-backed clone/boot/destroy, Aqua readiness polling, host-owned VM ownership records, fresh creator-birth and current-run checks for reclamation, and golden-image safety refusals. |
